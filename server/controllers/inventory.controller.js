...
const handleGetInventoryHospital = async (req, res) => {
    try {
        const inventory = await inventoryModel
...
const handleGetRecentInventory = async (req, res) => {
    try {
        const inventory = await inventoryModel
            .find({
                organisation: req.body.userId,
...
// GET DONAR REOCRDS
const handleGetDonars = async (req, res) => {
    try {
...
const handleGetHospital = async (req, res) => {
    try {
        const organisation = req.body.userId;
        //GET HOSPITAL ID
...
// GET ORG PROFILES
const handleGetOrgnaisation = async (req, res) => {
    try {
...
const handleGetOrgnaisationForHospital = async (req, res) => {
    try {
